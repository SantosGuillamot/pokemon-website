import { boolean, integer, jsonb, numeric, pgTable, primaryKey, serial, smallint, varchar } from 'drizzle-orm/pg-core';
...
export const pokemonMoves = pgTable(
  ...
  (table) => [
    primaryKey({ columns: [table.pokemonId, table.moveId] }),
  ]
);
